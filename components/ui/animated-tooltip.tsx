      ...
      {items.map((item, idx) => (
        ...
        >
          <AnimatePresence mode="wait">
            {hoveredIndex === item.id && (
              ...
              >
                ...
                <div className="font-bold text-secondary-foreground relative z-30 text-base">
                  {item.name}
                </div>
          ...
          <Image
            ...
            src={item.image}
            alt={item.name}
            className="object-cover !m-0 !p-0 object-top rounded-full h-20 w-20 border-2 group-hover:scale-150 group-hover:z-30 border-white  relative transition duration-200"
          />
        </div>
      ))}
    </>
